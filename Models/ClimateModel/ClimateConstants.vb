Module ClimateConstants
    ...
    Public Const EarthObliquityDeg As Double = 23.44         'Neigung der Erdachse in Grad
    Public ReadOnly Property EarthObliquityRad As Double    'Neigung der Erdachse als Rad
        Get
            Return EarthObliquityDeg * Math.PI / 180.0
        End Get
    End Property

    Public Const SideralSecondsPerDay As Double = 86164.0905          'Exakte Sekunden pro Tag
